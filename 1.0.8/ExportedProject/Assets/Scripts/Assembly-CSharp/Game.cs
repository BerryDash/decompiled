...
public class Game : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		...
		if (Application.platform == RuntimePlatform.WindowsPlayer || Application.platform == RuntimePlatform.LinuxPlayer || (Application.platform == RuntimePlatform.OSXPlayer && Input.GetKey(KeyCode.Escape)))
		{
			Application.Quit();
		}
	}
