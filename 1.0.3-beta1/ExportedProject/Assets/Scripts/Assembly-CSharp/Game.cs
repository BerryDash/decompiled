...
public class Game : MonoBehaviour
{
	...
	private void Start()
	{
		...
		obj.GetComponent<TextMesh>().text = "Score: 0";
		...
		GameObject obj2 = new GameObject("BoostText");
		obj2.AddComponent<TextMesh>();
		obj2.GetComponent<TextMesh>().text = "";
		...
		obj2.transform.position = new Vector3(0f, 3f, 0f);
		...
		if (Application.isMobilePlatform)
		{
			...
			GameObject obj3 = new GameObject("RestartButton");
			...
			obj3.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("restart");
			...
			obj3.transform.position = new Vector3(screenWidth / 2.17f, Camera.main.orthographicSize - 1f, 0f);
		}
