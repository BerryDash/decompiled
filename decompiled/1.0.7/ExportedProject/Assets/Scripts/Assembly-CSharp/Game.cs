...
public class Game : MonoBehaviour
{
	...
	public DateTime idleStarted = DateTime.UtcNow;
	...
	private void Start()
	{
		...
		GameObject obj3 = new GameObject("HighScoreText");
		obj3.AddComponent<TextMesh>();
		obj3.GetComponent<TextMesh>().text = $"High Score: {highscore}";
		...
		obj3.transform.position = new Vector3(0f, 3.1f, 0f);
		GameObject obj4 = new GameObject("BoostText");
		obj4.AddComponent<TextMesh>();
		obj4.GetComponent<TextMesh>().text = "";
		obj4.GetComponent<TextMesh>().characterSize = 0.1f;
		obj4.GetComponent<TextMesh>().fontSize = 50;
		obj4.GetComponent<TextMesh>().color = Color.white;
		obj4.GetComponent<TextMesh>().anchor = TextAnchor.MiddleCenter;
		obj4.transform.position = new Vector3(0f, 2.4f, 0f);
		...
		if (Application.isMobilePlatform)
		{
			...
			GameObject obj5 = new GameObject("RestartButton");
			gameObject.AddComponent<SpriteRenderer>();
			gameObject2.AddComponent<SpriteRenderer>();
			obj5.AddComponent<SpriteRenderer>();
			...
			obj5.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("restart");
			...
			obj5.transform.position = new Vector3(screenWidth / 2.17f, Camera.main.orthographicSize - 1f, 0f);
			...
			obj5.transform.localScale = new Vector3(screenWidth / 20.19257f, screenWidth / 20.19257f, 1f);
		}
	...
	private void OnApplicationFocus(bool focusStatus)
	{
		if (Application.platform == RuntimePlatform.WindowsPlayer || Application.platform == RuntimePlatform.LinuxPlayer || Application.platform == RuntimePlatform.OSXPlayer)
		{
			startTimestamp = startTimestamp.AddMinutes(0.0 - (DateTime.UtcNow - idleStarted).TotalMinutes);
			client.SetPresence(new RichPresence
			{
				Details = "Playing Foodie Dash",
				State = $"Score: {score}, High Score: {highscore}",
