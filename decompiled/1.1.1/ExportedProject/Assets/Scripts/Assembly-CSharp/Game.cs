...
public class Game : MonoBehaviour
{
	...
	private void MoveBird()
	{
		...
		if (Application.isMobilePlatform)
		{
			...
			if (gameObject5.GetComponent<SpriteRenderer>().bounds.Contains(point))
			{
		...
		if (Input.GetMouseButton(0))
		{
			...
			else if (gameObject3.GetComponent<SpriteRenderer>().bounds.Contains(point2))
			{
				gameObject.transform.position += new Vector3(num3, 0f, 0f);
				ClampPosition(num, gameObject);
				gameObject.transform.localScale = new Vector3(-1.35f, 1.35f, 1.35f);
		...
		if (gameObject4.GetComponent<SpriteRenderer>().bounds.Contains(point4))
		{
			gameObject.transform.position = new Vector3(0f, -4.5f, 0f);
			gameObject.transform.localScale = new Vector3(1.35f, 1.35f, 1.35f);
			score = 0;
	...
	private void Update()
	{
		...
		GameObject[] array3 = GameObject.FindGameObjectsWithTag("UltraBerry");
		GameObject[] array4 = GameObject.FindGameObjectsWithTag("SlowBerry");
		GameObject gameObject5 = GameObject.Find("Bird");
		GameObject[] array5 = array;
		foreach (GameObject gameObject6 in array5)
		{
			...
			else if (Vector3.Distance(gameObject5.transform.position, gameObject6.transform.position) < 1.5f)
			{
		...
		foreach (GameObject gameObject7 in array5)
		{
			...
			else if (Vector3.Distance(gameObject5.transform.position, gameObject7.transform.position) < 1.5f)
			{
				...
				gameObject5.transform.position = new Vector3(0f, -4.5f, 0f);
				gameObject5.transform.localScale = new Vector3(1.35f, 1.35f, 1.35f);
				score = 0;
				boostLeft = 0f;
				slownessLeft = 0f;
				UpdateScore(score);
		...
		foreach (GameObject gameObject8 in array5)
		{
			...
			else if (Vector3.Distance(gameObject5.transform.position, gameObject8.transform.position) < 1.5f)
			{
		...
		foreach (GameObject gameObject9 in array5)
		{
			...
			else if (Vector3.Distance(gameObject5.transform.position, gameObject9.transform.position) < 1.5f)
			{
